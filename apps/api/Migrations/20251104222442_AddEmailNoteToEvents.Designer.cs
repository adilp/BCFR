...
namespace MemberOrgApi.Migrations
{
    ...
    [Migration("20251104222442_AddEmailNoteToEvents")]
    partial class AddEmailNoteToEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemberOrgApi.Models.EmailCampaign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EmailCampaigns", "memberorg");
                });

            modelBuilder.Entity("MemberOrgApi.Models.EmailQueueItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CampaignId")
                        .HasDatabaseName("IX_EmailQueue_CampaignId");

                    b.HasIndex("UpdatedAt")
                        .HasDatabaseName("IX_EmailQueue_UpdatedAt");

                    b.HasIndex("CampaignId", "RecipientEmail")
                        .IsUnique()
                        .HasDatabaseName("UQ_Campaign_Recipient");

                    b.HasIndex("Status", "ScheduledFor", "NextRetryAt")
                        .HasDatabaseName("IX_EmailQueue_Processing");

                    b.ToTable("EmailQueue", "memberorg");
                });
            ...
            modelBuilder.Entity("MemberOrgApi.Models.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PasswordResetTokens", "memberorg");
                });

            modelBuilder.Entity("MemberOrgApi.Models.RsvpToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("UsedForResponse")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<bool?>("UsedWithPlusOne")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MemberOrgApi.Models.EmailQueueItem", b =>
                {
                    b.HasOne("MemberOrgApi.Models.EmailCampaign", "Campaign")
                        .WithMany()
